...
UPDATE `shopet`.`produto` SET `desc` = 'Melhor que o terceiro cafézinho só o quarto cafézinho, não é? Compre agora, o famoso cafézinho do PET, pra quando você estiver com sono durante sua rotina acadêmica ou simplesmente apreciar o sabor dos grãos petianenses, esse café faz montanhas se moverem e EPs completarem quase sozinhos, num passe de mágica. \\nAtenção: não beba somente café no seu dia, beba água também!\\n\\nXícara não inclusa' WHERE (`idproduto` = '35');
UPDATE `shopet`.`produto` SET `desc` = 'Você já estava fazendo alguma tarefa, se exercitando ou até jogando e se sentiu um pouco desmotivado? Então esse produto é pra você! Adquira agora a sua prórpia narração pessoal do João!!\\nVocê nunca mais vai ficar triste com uma narração pessoal, imagine como sua vida será melhor com o João narrando todos os seus passos em tempo real, 24 horas por dia!' WHERE (`idproduto` = '34');
UPDATE `shopet`.`produto` SET `desc` = 'Todos nós já sofremos com uma impressora em casa, sempre que precisamos ela decide que o cartucho de tinta acabou, mesmo que você tenha trocado essa semana.\\nPra você relembrar os bons tempos passando raiva na salinha com a impressora, compre agora mesmo a impressora quebrada do PET, um item raro de colecionador, quem sabe você consiga alivar a sua raiva batendo nela.' WHERE (`idproduto` = '36');
UPDATE `shopet`.`produto` SET `desc` = 'Grandes poderes vem com grandes responsabilidades, se você é um empreendedor júnior, que aos 23 anos já possui um carro de luxo e casa própria comprando ações e investindo na internet, esse produto é pra você!\\nCom a Maleta de Levar Dinheiro, você não precisa se preocupar com o seu dinheiro, sua tecnologia de segurança PETsecurity garante que nínguem, além de Caio, consiga ter acesso a sua grana!' WHERE (`idproduto` = '32');
UPDATE `shopet`.`produto` SET `desc` = 'Mulher Triângulo? Shrek Saxofonista? Xícara de Café fugindo da polícia? O que é isso? Um episódio de Simpsons? Não, é algo muito melhor!\\nTodas essas celebridades citadas podem ser encontradas nos livros do PET Literário, projeto secreto do PET-SI, compre agora para se divertir com as histórias e conhecer mais personagens!\\nApoio psicológico não incluido.' WHERE (`idproduto` = '40');
...
UPDATE `shopet`.`produto` SET `desc` = 'Se juntos já causam, imagine juntos!\\nTodo o domínio sobre a organização está nesse produto, dois petianos renomados pela sua organização se juntaram para fazer o item mais organizado do mundo, cuidado com seus olhos, você pode danificar a vista com a organização.' WHERE (`idproduto` = '39');
